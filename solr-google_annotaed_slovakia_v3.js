...
//Group Topic1
query_string[0]= encodeURI("(EÚ or Európa or EU or Europe or rozšírenie or bővítés) AND country:Slovakia");		
query_solr(query_string[0],"GroupT1");

//Group Topic1 R
query_string[2]= encodeURI("(EÚ or Európa or rozšírenie or bővítés) AND org_type:R AND country:Slovakia");		
query_solr(query_string[2],"GroupT1R");

//Group Topic1 L
query_string[1]= encodeURI("(EÚ or Európa or rozšírenie or bővítés) AND org_type:L AND country:Slovakia");		
query_solr(query_string[1],"GroupT1L");

//Group Topic2
query_string[3] = encodeURI("(Kisebbségek or romák or roma or cigány or cigányok or cigán or cigáni or magyar or (cigány probléma) or (kisebbségi jogok) or magyarok or (kettős állampolgárság) or Menšiny or Rómovia or Rómovia or Maďari or (Gypsy problém) or (práva menšín) or (práva Maďarov) or (dvojité občianstvo)) AND country:Slovakia");
query_solr(query_string[3],"GroupT2");

//Group Topic2 R
query_string[5] = encodeURI("(Kisebbségek or romák or roma or cigány or cigányok or cigán or cigáni or magyar or (cigány probléma) or (kisebbségi jogok) or magyarok or (kettős állampolgárság) or Menšiny or Rómovia or Rómovia or Maďari or (Gypsy problém) or (práva menšín) or (práva Maďarov) or (dvojité občianstvo)) AND org_type:R AND country:Slovakia");
query_solr(query_string[5],"GroupT2R");

//Group Topic2 L
query_string[4] = encodeURI("(Kisebbségek or romák or roma or cigány or cigányok or cigán or cigáni or magyar or (cigány probléma) or (kisebbségi jogok) or magyarok or (kettős állampolgárság) or Menšiny or Rómovia or Rómovia or Maďari or (Gypsy problém) or (práva menšín) or (práva Maďarov) or (dvojité občianstvo)) AND org_type:L AND country:Slovakia");
query_solr(query_string[4],"GroupT2L");

//Group Topic3 ////////////////////////
query_string[6] = encodeURI("(ľudia or občania or Slováci or národ or Narod or ludi or ludia or Slovaci or Slovenská or emberek or nép or szlovákok or nemzet or Narod or Ludi or ludia or Slováci or Slovensky) AND country:Slovakia");
query_solr(query_string[6],"GroupT3");

//Group Topic3 R ////////////////////////
query_string[8] = encodeURI("(ľudia or občania or Slováci or národ or Narod or ludi or ludia or Slovaci or Slovenská or emberek or nép or szlovákok or nemzet or Narod or Ludi or ludia or Slováci or Slovensky) AND country:Slovakia AND org_type:R");
query_solr(query_string[8],"GroupT3R");

//Group Topic3 L////////////////////////
query_string[7] = encodeURI("(ľudia or občania or Slováci or národ or Narod or ludi or ludia or Slovaci or Slovenská or emberek or nép or szlovákok or nemzet or Narod or Ludi or ludia or Slováci or Slovensky) AND country:Slovakia AND org_type:L");
query_solr(query_string[7],"GroupT3L");

//Group Topic4 ////////////////////////
query_string[9] = encodeURI("(Jazyk or (jazykový zákon) or právo or vzdelanie or škola or (menšinový jazyk) or menšina or zakon or Školstvo or Školstvo or skoly or jazykové or (škola akt) or (škola) or Language or nyelvtörvény or törvény or (az oktatás) or iskola or (kisebbségi nyelv) or kisebbség or zakon or skolstva or skolstvo or školy or nyelvi or (iskolai törvény) or iskola) AND country:Slovakia");
query_solr(query_string[9],"GroupT4");

//Group Topic4 R////////////////////////
query_string[11] = encodeURI("(Jazyk or (jazykový zákon) or právo or vzdelanie or škola or (menšinový jazyk) or menšina or zakon or Školstvo or Školstvo or skoly or jazykové or (škola akt) or (škola) or Language or nyelvtörvény or törvény or (az oktatás) or iskola or (kisebbségi nyelv) or kisebbség or zakon or skolstva or skolstvo or školy or nyelvi or (iskolai törvény) or iskola) AND country:Slovakia AND org_type:R");
query_solr(query_string[11],"GroupT4R");

//Group Topic4 L////////////////////////
query_string[10] = encodeURI("(Jazyk or (jazykový zákon) or právo or vzdelanie or škola or (menšinový jazyk) or menšina or zakon or Školstvo or Školstvo or skoly or jazykové or (škola akt) or (škola) or Language or nyelvtörvény or törvény or (az oktatás) or iskola or (kisebbségi nyelv) or kisebbség or zakon or skolstva or skolstvo or školy or nyelvi or (iskolai törvény) or iskola) AND country:Slovakia AND org_type:L");
query_solr(query_string[10],"GroupT4L");

//Grid Topic1
query_string[12] = encodeURI("(EÚ or Európa or EU or Europe or rozšírenie or bővítés) AND country:Slovakia");
query_solr(query_string[12],"GridT1");

//Grid Topic1 R
query_string[14] = encodeURI("(EÚ or Európa or EU or Europe or rozšírenie or bővítés) AND org_type:R AND country:Slovakia");
query_solr(query_string[14],"GridT1R");

//Grid Topic1 L
query_string[13] = encodeURI("(EÚ or Európa or EU or Europe or rozšírenie or bővítés) AND org_type:L AND country:Slovakia");
query_solr(query_string[13],"GridT1L");

//Grid Topic2
query_string[15] = encodeURI("(Közgazdasági or (Regionális fejlesztés) or támogatás or (régiók gazdaságpolitika) or gazdasági or ekonomika or (Regionálny rozvoj) or udeliť or regióny or (hospodárska politika) or ekonomické) AND country:Slovakia");
query_solr(query_string[15],"GridT2");

//Grid Topic2 R
query_string[17] = encodeURI("(Közgazdasági or (Regionális fejlesztés) or támogatás or (régiók gazdaságpolitika) or gazdasági or ekonomika or (Regionálny rozvoj) or udeliť or regióny or (hospodárska politika) or ekonomické) AND org_type:R AND country:Slovakia");
query_solr(query_string[17],"GridT2R");

//Grid Topic2 L
query_string[16] = encodeURI("(Közgazdasági or (Regionális fejlesztés) or támogatás or (régiók gazdaságpolitika) or gazdasági or ekonomika or (Regionálny rozvoj) or udeliť or regióny or (hospodárska politika) or ekonomické) AND org_type:L AND country:Slovakia");
query_solr(query_string[16],"GridT2L");

//Grid Topic3
query_string[18] = encodeURI("((Medzištátne vzťahy) or vzťahy or medzištátne or Maďarsko or Madarsko or Orban or Budapešť or (Államközi kapcsolatok) or kapcsolatok or államközi or Magyarország or Madarsko or Orbán or Budapest) AND country:Slovakia");
query_solr(query_string[18],"GridT3");

//Grid Topic3 R
query_string[20] = encodeURI("((Medzištátne vzťahy) or vzťahy or medzištátne or Maďarsko or Madarsko or Orban or Budapešť or (Államközi kapcsolatok) or kapcsolatok or államközi or Magyarország or Madarsko or Orbán or Budapest) AND org_type:R AND country:Slovakia");
query_solr(query_string[20],"GridT3R");

//Grid Topic3 L
query_string[19] = encodeURI("((Medzištátne vzťahy) or vzťahy or medzištátne or Maďarsko or Madarsko or Orban or Budapešť or (Államközi kapcsolatok) or kapcsolatok or államközi or Magyarország or Madarsko or Orbán or Budapest) AND org_type:L AND country:Slovakia");
query_solr(query_string[19],"GridT3L");
...
{
  //do some things
  setTimeout(build_and_draw,2000); //wait few seconds before continuing
}
UncheckAll();
function UncheckAll(){ 
...
///////get timeline date change event
	google.visualization.events.addListener(slovakia_chart, 'ready', function() {
   
	google.visualization.events.addListener(slovakia_chart, 'rangechange', handleRangeChange);
	});
	///////end timeline date change
...
////////////////////  Handle range change function
 function handleRangeChange() {
	...
	var obj = slovakia_chart.getVisibleChartRange();
	var start =obj.start;
	var d = new Date(start);
	start = d.getFullYear()+"-"+(d.getMonth()+1)+"-"+d.getDate()+"T00:00:00Z";
	
	var end =obj.end;
	d = new Date(end);
	end = d.getFullYear()+"-"+(d.getMonth()+1)+"-"+d.getDate()+"T00:00:00Z";
	
	//build query for all checked boxes
	var long_query="";
	var w = document.getElementsByTagName('input'); 	
      for(var i = 0; i < w.length; i++){ 
        if(w[i].type=='checkbox'){ 
          if(w[i].checked){
			if(long_query=="")
				long_query = "(h_file_content:"+decodeURI(query_string[i])+")";
			else
				long_query = long_query+" or (h_file_content:"+decodeURI(query_string[i])+")";
			}			  
        }
      }
    ...
    if (window.XMLHttpRequest) {
	 ...
	 var query = encodeURI(long_query+"&fq=article_date:["+start+" TO "+end+"]");  //&fq=article_date:[2013-07-17T00:00:00Z TO NOW]
	 var link ="http://localhost:8983/solr/collection1/select?q="+query+"&rows=50000&fl=doc_id%2Carticle_date%2Ch_file_content&wt=json&json.wrf=?&indent=true";
	xmlhttp.open("GET",link,true);
	xmlhttp.send();
	xmlhttp.onreadystatechange=function()
      {
      if (xmlhttp.readyState==4 && xmlhttp.status==200)
        {
		  var str = xmlhttp.responseText; //json response that has the following: doc_id, article_date, and h_file_content (which is the articles content)  
    	 // var temp = str.replace("?", "");
    	 // var temp2 = temp.replace(/\(/gm,"");
    	 // var res = temp2.replace(/\)/gm,"");
    	  //var strJSON = res;
...
///////////  end of  Handle range change function
